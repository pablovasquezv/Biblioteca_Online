...
<?php           
    foreach($listadoLibros as $row){ ?>
        ...
        <tr>
            ...
            <td><button onclick="cargaLibroDetalle(<?php echo $row['id_libro']; ?>)"  class="btn btn-primary btn-sm" data-toggle="modal" data-target="#ModalCargaDetalleLibro" >Ver Libro</button></td>
