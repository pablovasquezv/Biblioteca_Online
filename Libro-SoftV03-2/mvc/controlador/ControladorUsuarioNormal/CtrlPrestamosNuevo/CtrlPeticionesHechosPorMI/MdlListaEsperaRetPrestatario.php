...
$estado_prestamo = "Espera retiro prestatario";
...
?>
        ...
        <tr>
            ...
            <td>
                <?php
                    if ($row["nombre_estado_prestamo"] == "Espera retiro prestatario") {
                        echo "El libro solicitado ya se encuentra disponible para retirar en el punto de intercambio.";
                    }
                ?>
