...
$estado_prestamo = "Petición Aceptada";
...
?>
        ...
        <tr>
            ...
            <td><button class="btn btn-dark btn-sm" onclick="cargaModalModificaEstadoPrestamoAceptado(<?php echo $row['id_prestamo']; ?>, <?php echo $row['dias_prestamo']; ?>)"  data-toggle="modal" data-target="#ModalModificaEstadoPrestamoAceptado">Cambiar Estado</button></td>
