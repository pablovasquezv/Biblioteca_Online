...
<html lang="es">
  <head>
    ...
    <title>Libros Admin Sistema - Libro-Soft V02</title>
  </head>
  <body>
<?php
    ...
    <div class="container">
        ...
        <section>
            <div class="container">
                ...
                <h4 class="adminSistema">Administración Libros</h4>

                <a href="../FrmHomeAdminSistema.php"><button class="btn btn-outline-dark"><< Volver</button></a>

                <!-- <button onclick="cargaModalAgregaAutor()" class="btn btn-success btn-sm"  data-toggle="modal" data-target="#ModalAgregaAutor">Agregar Autor</button>-->
                <hr>
                <div id="muestraLibros" class="table-responsive">Listado de Libros</div>
