...
<html lang="es">
  <head>
    ...
    <script src="../../../../js/FuncionesAdminSistema/FuncionesPtosIntercambio/FuncionesPtosIntercambio.js"></script>  
    <link rel='icon' href='../../../../media/img/Logos/SoloLogo.ico' type='image/x-icon' sizes="16x16" />

    <title>Puntos Intercambio Admin Sistema - Libro-Soft V02</title>
  </head>
  <body>
<?php
    ...
    <div class="container">
        ...
        <section>
            <div class="container">
                ...
                <h4 class="adminSistema">Administración Puntos de Intercambio</h4>

                <a href="../FrmHomeAdminSistema.php"><button class="btn btn-outline-dark"><< Volver</button></a>

                <button onclick="cargaModalAgregaPtoIntercambio()" class="btn btn-success btn"  data-toggle="modal" data-target="#ModalAgregaPuntoIntercambio">Agregar Punto Intercambio</button>
                <hr>
                <div id="muestraPuntosDeIntercambio" class="table-responsive">Listado de Puntos de Intercambio</div>
                
                

                <!-- MODAL Agregar Punto Intercambio -->
                <div class="modal fade" id="ModalAgregaPuntoIntercambio" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Agregar Punto Intercambio</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <div id="frmAgregarPuntoIntercambio"></div>                                    
                            </div>
                ...
                <!-- MODAL DECIDE ELIMINAR Pto Intercambio -->
                <div class="modal fade" id="ModalDecideEliminarPtoIntercambio" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Eliminar Punto Intercambio</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <div id="frmEliminaPtoIntercambio"></div>                                    
                            </div>
                            <div class="modal-footer">
                            </div>
                        </div>
                ...
                <!-- MODAL MODIFICA Punto Intercambio -->
                <div class="modal fade" id="ModalModificaPtoIntercambio" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Modificar Punto Intercambio</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <div id="frmModificaPtoIntercambio"></div>                                    
                            </div>
                            <div class="modal-footer">
                            </div>
                        </div>
