...
<html lang="es">
  <head>
    ...
    <script src="../../../../js/FuncionesAdminSistema/FuncionesGeneros/funcionesGenero.js"></script>  
    <link rel='icon' href='../../../../media/img/Logos/SoloLogo.ico' type='image/x-icon' sizes="16x16" />

    <title>Genenros Admin Sistema - Libro-Soft V02</title>
  </head>
  <body>
<?php
    ...
    <div class="container">
        ...
        <section>
            <div class="container">
                ...
                <h4 class="adminSistema">Generos</h4>

                <a href="../FrmHomeAdminSistema.php"><button class="btn btn-outline-dark"><< Volver</button></a>

                <button onclick="cargaModalAgregaGenero()" class="btn btn-success btn"  data-toggle="modal" data-target="#ModalAgregaGenero">Agregar Genero</button>
                <hr>
                <div id="muestraGeneros" class="table-responsive">Listado de Generos</div>
                ...
                <!-- MODAL DECIDE ELIMINAR Generos -->
                <div class="modal fade" id="ModalDecideEliminarGenero" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                ...
                <!-- MODAL MODIFICA Generos -->
                <div class="modal fade" id="ModalModificaGenero" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Modificar Genero</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <div id="frmModificaGenero"></div>                                    
                            </div>
                            <div class="modal-footer">
                            </div>
                        </div>
