...
<html lang="es">
  <head>
    ...
    <script src="../../../../js/FuncionesAdminSistema/FuncionesCiudades/funcionesCiudades.js"></script>  
    <link rel='icon' href='../../../../media/img/Logos/SoloLogo.ico' type='image/x-icon' sizes="16x16" />

    <title>Ciudades Admin Sistema - Libro-Soft V02</title>
  </head>
  <body>
<?php
    ...
    <div class="container">
        ...
        <section>
            <div class="container">
                ...
                <h4 class="adminSistema">Ciudades</h4>

                <a href="../FrmHomeAdminSistema.php"><button class="btn btn-outline-dark"><< Volver</button></a>
                <button onclick="cargaModalAgregaCiudad()" class="btn btn-success btn"  data-toggle="modal" data-target="#ModalAgregaCiudad">Agregar Ciudad</button>
                <hr>
                <div id="muestraCiudades" class="table-responsive">Listado de Ciudades</div>
                
                <!-- MODAL AGREGA CIUDADES -->
                <div class="modal fade" id="ModalAgregaCiudad" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Agrega Ciudad</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <div id="frmAgregaCiudad"></div>                                    
                            </div>
                ...
                <!-- MODAL DECIDE ELIMINAR CIUDADES -->
                <div class="modal fade" id="ModalDecideEliminarCiudad" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                ...
                <!-- MODAL MODIFICA CIUDADES -->
                <div class="modal fade" id="ModalModificaCiudad" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
