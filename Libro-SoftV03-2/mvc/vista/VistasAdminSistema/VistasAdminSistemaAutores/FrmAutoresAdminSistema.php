...
<html lang="es">
  <head>
    ...
    <script src="../../../../js/FuncionesAdminSistema/FuncionesAutores/funcionesAutores.js"></script>  
    <link rel='icon' href='../../../../media/img/Logos/SoloLogo.ico' type='image/x-icon' sizes="16x16" />

    <title>Autores Admin Sistema - Libro-Soft V02</title>
  </head>
  <body>
<?php
    ...
    <div class="container">
        ...
        <section>
            <div class="container">
                ...
                <h4 class="adminSistema">Autores</h4>

                <a href="../FrmHomeAdminSistema.php"><button class="btn btn-outline-dark"><< Volver</button></a>
                <button onclick="cargaModalAgregaAutor()" class="btn btn-success btn"  data-toggle="modal" data-target="#ModalAgregaAutor">Agregar Autor</button>
                <hr>
                <div id="muestraAutores" class="table-responsive">Listado de Autores</div>
                ...
                <!-- MODAL DECIDE ELIMINAR AUTORES -->
                <div class="modal fade" id="ModalDecideEliminarAutor" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                ...
                <!-- MODAL MODIFICA AUTORES -->
                <div class="modal fade" id="ModalModificaAutor" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
