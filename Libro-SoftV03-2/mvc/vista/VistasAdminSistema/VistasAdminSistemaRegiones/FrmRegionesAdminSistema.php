...
<html lang="es">
  <head>
    ...
    <title>Regiones Admin Sistema - Libro-Soft V02</title>
  </head>
  <body>
<?php
    ...
    <div class="container">
        ...
        <section>
            <div class="container">
                ...
                <h4 class="adminSistema">Regiones</h4>
                <a href="../FrmHomeAdminSistema.php"><button class="btn btn-outline-dark"><< Volver</button></a>
                <button onclick="cargaModalAgregaRegion()" class="btn btn-success btn"  data-toggle="modal" data-target="#ModalAgregaRegion">Agregar Región</button>
                <hr>
                <div id="muestraRegiones" class="table-responsive">Listado de regiones</div>
                
                <!-- MODAL AGREGA REGIONES -->
                <div class="modal fade" id="ModalAgregaRegion" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Agrega Region</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <div id="frmAgregaRegion"></div>                                    
                            </div>
                ...
                <!-- MODAL DECIDE ELIMINAR REGIONES -->
                <div class="modal fade" id="ModalDecideEliminarRegion" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                ...
                <!-- MODAL DECIDE ELIMINAR REGIONES -->
                <div class="modal fade" id="ModalModificaRegion" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Modificar Region</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <div id="frmModificaRegion"></div>                                    
                            </div>
                            <div class="modal-footer">
                            </div>
                        </div>
