    ...
    <div class="container">
        ...
        <section>
            <div class="container">
                ...
                <h4 class="adminSistema">Administradores Puntos de Intercambio</h4>

                <a href="../FrmHomeAdminSistema.php"><button class="btn btn-outline-dark"><< Volver</button></a>

                <button onclick="cargaModalAgregaAdminPtoIntercambio()" class="btn btn-success btn"  data-toggle="modal" data-target="#ModalAgregaAdminPuntoIntercambio">Agregar Administrador Punto Intercambio</button>
                <hr>
                <div id="muestraAdminPuntosDeIntercambio" class="table-responsive">Listado de Administradores Puntos de Intercambio</div>
                ...
                <!-- MODAL Detalles Administrador Punto Intercambio -->
                <div class="modal fade" id="ModalDetallesAdminPtoIntercambio" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Detalles Administrador Punto Intercambio</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <div id="frmDetallesAdminPtoIntercambio"></div>                                    
                            </div>
                            <div class="modal-footer">
                            </div>
                        </div>
                ...
                <!-- MODAL Modifica Asiganción Punto de intercambio -->
                <div class="modal fade" id="ModalModificaAsignacionPtoIntercambio" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Modificar Asignación Punto Intercambio</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <div id="frmModificarAsignacionPtoIntercambio"></div>                                    
                            </div>
                            <div class="modal-footer">
                            </div>
                        </div>
