    ...
    <div class="container">
        ...
        <section>
            <div class="container well">
                ...
                <h3><a href="../FrmPrestamosPeticiones.php"><button class="btn btn-outline-dark"><< Volver</button></a> Estado Prestamos Realizados En Curso</h3>
                <div id="Prestamo"></div>
                <hr>
                <!-- BARRA NAVEGACIÓN ENTRE LISTADOS DE PETICIONES EN ESPERA, CANCELADAS O RECHAZADAS -->
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link" href="FrmPrestamoAceptado.php">Aceptados</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="FrmEsperaRetPrestatario.php"> <b>ESPERA RETIRO PRESTATARIO</b> </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="FrmPrestado.php">Prestados</a>
                    </li> 
                    <li class="nav-item">
                        <a class="nav-link" href="FrmDevueltos.php">Devueltos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="FrmPerdidosRobados.php">Perdidos/Robados</a>
                    </li>                    
                </ul>
                               
                    <div id="frmPeticionesHechasPorMiEnEsperaRetiroPrestatario"></div>
        ...
        <!-- MODAL CON DETALLE DEL PRESTAMO EN CURSO -->
        <div class="modal fade" id="ModalDetallePrestamoEnCurso" tabindex="-1" role="dialog">
