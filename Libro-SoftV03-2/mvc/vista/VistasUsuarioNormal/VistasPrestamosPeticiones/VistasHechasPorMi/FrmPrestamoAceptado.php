        ...
        <section>
            <div class="container well">
                ...
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link active" href="FrmPrestamoAceptado.php"><b>ACEPTADOS</b></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="FrmEsperaRetPrestatario.php">Espera Retiro Prestatario</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div id="frmPeticionesHechasPorMiAceptadas"></div>
