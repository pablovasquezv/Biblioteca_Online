        ...
        <section>
            <div class="container well">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="FrmPrestado.php">Prestado</a>
                    </li> 
                    <li class="nav-item">
                        <a class="nav-link" href="FrmDevueltos.php">Devueltos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="FrmPerdidosRobados.php"><b>PERDIDOS/ROBADOS</b></a>
                    </li>                    
                </ul>
                               
                    <div id="frmPeticionesHechasPorMiPerdidosRobados"></div>
