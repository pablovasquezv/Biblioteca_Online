        ...
        <section>
            <div class="container well">
                ...
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link" href="FrmPeticionesRealizadas.php">En espera respuesta</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="FrmPeticionesCanceladas.php">Canceladas</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="FrmPeticionesRechazadas.php"><b>RECHAZADAS</b></a>
                    </li>                  
                </ul>
                               
                    <div id="frmPeticionesHechasPorMiRechazadas"></div>
