...
<html lang="es">
  <head>
    ...
    <title>Estado PrestamoRecibido | Libro-Soft V03</title>
  </head>
  <body>
<?php
    ...
    <div class="container">
        ...
        <section>
            <div class="container well">
              ...
              <h3 style="text-align: center">Listado Estado Prestamos Recibidos en Curso y Rechazadas</h3>
                <div id="Prestamo"></div>
                <hr>
            
                
                <div id="frmListadoPrestamosAceptadosEC"></div>
...
<div id="ModalDetallePeticionEC" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Detalle Petición En Curso</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
     <div id="FrmDetallePeticionEC"> </div>
      </div>
