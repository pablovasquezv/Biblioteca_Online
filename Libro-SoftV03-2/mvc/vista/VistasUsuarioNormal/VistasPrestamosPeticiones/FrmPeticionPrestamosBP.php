...
<html lang="es">
  <head>
    ...
    <title>Prestamos y Peticiones Biblioteca Publica | Libro-Soft V03</title>
  </head>
  <body>
<?php
    ...
    <div class="container">
        ...
        <section>
            <div class="container well">
              ...
              <h3 style="text-align: center">Listado de Peticiones Recibidas</h3>
                <div id="Prestamo"></div>
                <hr>
            
                
                <div id="frmPeticionesBibliotecaPublica2"></div>
...
<div id="ModalAceptaPeticion" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Acepta Peticiones</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
     <div id="FrmAceptaPeticion"> </div>
      </div>
...
<div id="ModalRechazaPeticion" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Rechaza Peticiones</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
       <div id="FrmRechazaPeticion"> </div>
        </div>
        <div class="modal-footer">
