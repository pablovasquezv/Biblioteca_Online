        ...
        <section>
            <div class="container">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="FrmListadoDevueltosExito.php">Devueltos a dueño</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="FrmListadoCancelados.php">Cancelados</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="FrmListadoRechazados.php">Rechazados</a>
                    </li>
                    <li class="nav-item">
                ...
                <hr>
                    ...
                    <div id="frmListadoPrestamosRechazados">LISTADO PRESTAMOS Rechazados</div>
