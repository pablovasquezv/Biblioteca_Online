        ...
        <section>
            <div class="container">
                ...
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link active" href="FrmListadoPrestamosFin.php">TODOS LOS PRESTAMOS TERMINADOS</a>
                    </li>
                    <li class="nav-item">
                ...
                <hr>
                    ...
                    <div id="frmListadoPrestamosTerminados">LISTADO PRESTAMOS TERMINADOS</div>
