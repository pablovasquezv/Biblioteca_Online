        ...
        <section>
            <div class="container">
                ...
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link" href="FrmListadoPrestamosFin.php">TODOS LOS PRESTAMOS TERMINADOS</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="FrmListadoDevueltosExito.php">Devueltos a dueño</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="FrmListadoCancelados.php">Cancelados</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="FrmListadoRechazados.php">Rechazados</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="FrmListadoPerdidos.php">Perdidos</a>
                    </li>  
                    <li class="nav-item">
                        <a class="nav-link" href="FrmListadoRobados.php">Robados</a>
                    </li>                  
                </ul>
                ...
                <hr>
                    ...
                    <div id="frmListadoPrestamosTerminadosExitosamente">LISTADO PRESTAMOS TERMINADOS EXITOSAMENTE</div>
