        ...
        <section>
            <div class="container">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="FrmListadoDevueltoPto.php">Devuelto a Pto Intercambio</a>
                    </li>                   
                </ul>
                ...
                <hr>
                    ...
                    <div id="frmListadoPrestamosDevueltosPtoIntercambio">LISTADO PRESTAMOS DEVUELTOS A PUNTO DE INTERCAMBIO</div>
