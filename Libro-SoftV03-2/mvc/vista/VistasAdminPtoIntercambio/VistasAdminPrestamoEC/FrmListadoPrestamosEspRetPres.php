...
?>
    ...
    <div class="container">
        ...
        <section>
            <div class="container">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="FrmListadoPrestamosAcept.php">Aceptados</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="FrmListadoPrestamosEspRetPres.php">Espera Retiro Prestatario</a>
                    </li>
                    <li class="nav-item">
                ...
                <hr>
                    ...
                    <div id="frmListadoPrestamosEnEsperaRetiroPrestatario">LISTADO PRESTAMOS EN ESPERA RETIRO PRESTATARIO</div>
        ...
        <div class="modal fade" id="ModalModificaEstadoPrestamo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div id="frmModificaEstadoPrestamo"></div>                                    
                    </div>
